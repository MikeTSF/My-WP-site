...
<form id="smplclssc_search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get">
	<div><input class="smplclssc_search-txt" type="search" name="s" id="s" value="<?php _e( 'Enter search keyword', 'simplaclassic' ); ?>" onfocus="if ( this.value == '<?php _e( 'Enter search keyword', 'simplaclassic' ); ?>' ) { this.value = ''; }" onblur="if ( this.value == '' ) { this.value = '<?php _e( 'Enter search keyword', 'simplaclassic'); ?>'; }" /></div>
