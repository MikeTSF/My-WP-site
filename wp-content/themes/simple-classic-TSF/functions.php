...
function simpleclassic_script() {
	wp_enqueue_script( 'simpleclassic', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '1.0.0', true );
	wp_enqueue_script( 'simpleclassic', get_template_directory_uri() . 'http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js', array('mytheme'), '20150421', true );
	wp_enqueue_style( 'simpleclassic', 'http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css' );
	wp_enqueue_style( 'simpleclassic-content-sidebar',  get_template_directory_uri() . '/layouts/content-sidebar.css' );
	wp_enqueue_script( 'simpleclassic-hide-search', get_template_directory_uri() . '/js/hide-search.js', array('jquery'), '20140404', true );
