 ...
 * Add a widget
 */
class jolene_SocialIcons extends WP_Widget {

	function jolene_SocialIcons() {

		/* Widget settings. */
		$widget_ops = array(
		'classname' => 'jolene_socialicons',
		'description' => __('Display Social Media Links.', 'jolene' ));

		/* Widget control settings. */
		$control_ops = array(
		'width' => 250,
		'height' => 250,
		'id_base' => 'jolene_socialicons_widget');

		/* Create the widget. */
		$this->WP_Widget('jolene_socialicons_widget', __( 'Social Media Icons', 'jolene' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$this->echo_input_text('title', $instance, __( 'Title: ', 'jolene' ), 0);
		
		$this->echo_input_checkbox('is_small', $instance, __( 'Small Icons.', 'jolene'));
		$this->echo_input_checkbox('is_vertical', $instance, __( 'Vertical Icons.', 'jolene'));
...
/* Register widget*/
function jolene_register_social_widgets() {
	register_widget( 'jolene_SocialIcons' );
}
add_action( 'widgets_init', 'jolene_register_social_widgets' );
