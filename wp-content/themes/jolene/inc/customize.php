...
?>
	...
	<style type="text/css"> 
		...
		<?php if( get_theme_mod('widget_back', $def_colors['widget_back']) != '') : ?>
			.column .widget {
				background: <?php echo esc_attr(get_theme_mod('widget_back', $def_colors['widget_back'])); ?>;
				opacity: 0.8;
			}
		<?php endif; ?>
...
function jolene_get_column_background(){
	$url = apply_filters( 'jolene_column_background', get_template_directory_uri().'/img/back-sidebar.png');
	return $url;
}
...
//New section in customizer: Featured Image
	$wp_customize->add_section( 'jolene_icons', array(
		...
		'description'          => __( 'Add your Social Media Links', 'jolene' ),
		'priority'       => 101,
	) );
